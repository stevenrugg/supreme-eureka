          ...
          <div className="col-span-3 justify-center space-y-5 align-middle">
            <span className="relative inset-y-4 ml-24 inline-block px-1 before:absolute before:-inset-1 before:block before:-skew-y-6 before:rounded-lg before:bg-primary-600 before:bg-opacity-20 sm:inset-y-7 sm:ml-40">
              <span className="relative inline-block -rotate-6 text-primary-500">
                <Link
                  href="https://twitter.com/stevensupergeek" className="font-arrow2 text-sm font-bold text-primary-500 transition hover:underline hover:underline-offset-8 sm:text-xl">@stevensupergeek
                </Link>
              </span>
            </span>
...
wrapper='h1'></Typical>
            ...
            <p className="text-black dark:text-white sm:pr-6 sm:text-lg sm:leading-8">
              Welcome to my corner of the WWW.<span className=""> My blog allows me to express myself with </span> 
technology<span className=""> using my diverse, creative skillset.</span> I'm passionate about learning and applying my knowledge: to create, to entertain, to dazzle, to wonder & to dare to dream.{' '}
              {/* In my
              ...
              about my journey as an Entrepreneur. */}
                ...
                Enjoy the Site! <span className="waving-hand text-2xl">👋🏻</span>
            </p>
